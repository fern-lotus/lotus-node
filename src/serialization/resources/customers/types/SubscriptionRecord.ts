...
> = core.serialization.object({
    ...
    autoRenew: core.serialization.property("auto_renew", core.serialization.boolean()),
    ...
    subscriptionFilters: core.serialization.property(
        ...
        core.serialization.list(
            core.serialization.lazyObject(async () => (await import("../../..")).SubscriptionCategoricalFilter)
        )
    ),
    customer: core.serialization.lazyObject(async () => (await import("../../..")).LightweightCustomer),
    billingPlan: core.serialization.property(
        "billing_plan",
        core.serialization.lazyObject(async () => (await import("../../..")).LightweightPlanVersion)
    ),
    fullyBilled: core.serialization.property("fully_billed", core.serialization.boolean()),
});
