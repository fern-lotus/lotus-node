...
export const Customer: core.serialization.ObjectSchema<serializers.Customer.Raw, LotusApi.Customer> =
    core.serialization.object({
        ...
        invoices: core.serialization.list(
            core.serialization.lazyObject(async () => (await import("../../..")).LightweightInvoice)
        ),
        totalAmountDue: core.serialization.property("total_amount_due", core.serialization.number()),
        subscriptions: core.serialization.list(
            core.serialization.lazyObject(async () => (await import("../../..")).SubscriptionRecord)
        ),
        integration: core.serialization.lazyObject(async () => (await import("../../..")).CustomerIntegrations),
        defaultCurrency: core.serialization.property(
            "default_currency",
            core.serialization.lazyObject(async () => (await import("../../..")).PricingUnit)
        ),
        paymentProvider: core.serialization.property(
            "payment_provider",
            core.serialization.lazy(async () => (await import("../../..")).PaymentProvider).optional()
        ),
